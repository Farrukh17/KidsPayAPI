    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paymentTime', models.DateTimeField(default=datetime.datetime(2019, 10, 25, 20, 47, 2, 388312), verbose_name='Время оплаты')),
                ...
                ('cheque', models.FileField(null=True, upload_to='cheques', verbose_name='Чек')),
